# Forensic Evidence Report -- Northshore Clinic Ransomware (Sample)

**Case ID:** ARIA-SAMPLE-001  
**Examiner of record:** Sample Analyst  
**Analysis system:** ARIA v0.1.0 (AI-assisted, examiner-reviewed)  
**Report generated:** 2026-08-10T16:02:34.016945+00:00
...
|---|---|---|---|---|---|
| disk-evidence | disk | `data/sample_incident/disk_manifest.json` | `unverified-in-demo-mode` | 2026-08-10T16:02:34.016911+00:00 | Disk artifact manifest provided at CLI invocation. |
| memory-evidence | memory | `data/sample_incident/memory_manifest.json` | `unverified-in-demo-mode` | 2026-08-10T16:02:34.016935+00:00 | Memory artifact manifest provided at CLI invocation. |
| logs-evidence | logs | `data/sample_incident/log_manifest.json` | `unverified-in-demo-mode` | 2026-08-10T16:02:34.016940+00:00 | Logs artifact manifest provided at CLI invocation. |
| pcap-evidence | pcap | `data/sample_incident/pcap_manifest.json` | `unverified-in-demo-mode` | 2026-08-10T16:02:34.016943+00:00 | Pcap artifact manifest provided at CLI invocation. |
...
- Observation: svc_backup is not enrolled in MFA and holds Backup Operators, Domain Admins access.
- Supporting evidence: logs-01
- Analysis confidence: 0.6
- Analysis module: IAM Auditor
...
- Case ARIA-SAMPLE-001 opened for Northshore Clinic Ransomware (Sample) with 4 artifact(s).
...
I, Sample Analyst, reviewed the automated findings above against the source evidence and attest to their accuracy as of the date of this report, subject to the caveats noted herein. Signature: ________________________  Date: ________________